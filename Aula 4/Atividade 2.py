...
while True:
    try:
        ...
        if opcao == 1:
            ...
            logger.info("Listagem finalizado")
            ...
            break
    except ValueError as error: # Especificando o Error, valor inválido
...
""" 
    ...
    continue  
 """
##Aqui é um erro generico, sabemos que teve um erro porém nao oq especificamente